    ...
    <>
          ...
          <div className="relative grid gap-6 lg:grid-cols-2">
            {FACILITY.map((f, i) => (
              <motion.div
                ...
                className="card flex items-center justify-between border-gold/20 bg-white/10 p-8 backdrop-blur"
              >
                <span className="text-[11px] font-bold uppercase tracking-[0.26em] text-cream/65">
                  {f.label}
                </span>
        ...
        <div className="container-x grid gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <SectionHeading
              ...
              className="mb-8"
            />
            <div className="space-y-5 text-sm leading-relaxed text-cream/70">
              <p>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={line} className="flex items-start gap-3 text-cream/75">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4">
              <div className="card p-6 text-center">
                ...
                <div className="text-[9px] font-bold uppercase tracking-[0.24em] text-cream/55">
                  sq/ft campus
                </div>
              </div>
              <div className="card p-6 text-center">
            ...
            <div className="card sticky top-28 p-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-2.5">
                {EQUIPMENT.map((eq) => (
                  <div
                    key={eq}
                    className="border border-cream/10 px-3 py-2.5 text-[11px] font-semibold text-cream/70 transition-colors hover:border-gold/50 hover:text-gold"
                  >
                    {eq}
                  </div>
                ))}
      ...
      <section className="border-y border-cream/10 bg-navy py-20">
        <div className="container-x">
          ...
          <div className="mt-10 grid gap-px overflow-hidden border border-cream/10 bg-cream/10 sm:grid-cols-3">
            {[
              "500-point inline QC",
              "AQL 2.5 final audit",
              "Third-party lab reports",
            ].map((t) => (
              <div key={t} className="flex items-center gap-3 bg-navy px-6 py-5 text-sm font-semibold text-cream/75">
