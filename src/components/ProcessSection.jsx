    ...
    <section id="process" className="relative overflow-hidden py-16 sm:py-24">
      <div className="container-x">
        ...
        <div className="relative">
          <div className="absolute left-[27px] top-0 h-full w-px bg-cream/10 lg:left-1/2" />
          <motion.div
            initial={{ scaleY: 0 }}
                ...
                >
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <span className="font-display text-6xl font-black text-cream/8">{step.num}</span>
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-cream/65">{step.desc}</p>
                  </motion.div>
                </div>
              );
            })}
