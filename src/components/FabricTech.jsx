        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="mb-2 flex gap-3">
            <button
              ...
              onClick={() => scrollBy(-1)}
              className="grid h-12 w-12 place-items-center border border-white/15 text-white transition-colors hover:border-gold hover:text-gold"
            >
          ...
          {FABRICS.map((f, i) => (
            ...
            >
              <div className="card h-full p-5">
                ...
                <a
                  href="#contact"
                  className="mt-5 block border-t border-white/10 pt-4 text-[11px] font-bold uppercase tracking-[0.26em] text-gold hover:text-gold-light"
                >
                  Request Sample →
                </a>
              </div>
