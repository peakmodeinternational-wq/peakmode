              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-white/15 bg-ink px-4 py-3.5 text-sm text-white outline-none transition-colors placeholder:text-white/25 focus:border-gold"
                  />
                </div>
                <div>
                  <label className="mb-2 block text-[10px] font-bold uppercase tracking-[0.26em] text-white/55">
                ...
                <div>
                  ...
                  <select
                    required
                    className="w-full border border-white/15 bg-ink px-4 py-3.5 text-sm text-white outline-none transition-colors focus:border-gold"
                  >
                    {PRODUCTS.map((p) => (
                      <option key={p.id} value={p.name} className="bg-navy">
                        {p.name}
                      </option>
                    ))}
                    <option value="Other" className="bg-navy">Other — tell us below</option>
                  </select>
                </div>
                <div>
                  <label className="mb-2 block text-[10px] font-bold uppercase tracking-[0.26em] text-white/55">
                  ...
                  <select className="w-full border border-white/15 bg-ink px-4 py-3.5 text-sm text-white outline-none transition-colors focus:border-gold">
                    {["300 – 1,000 pcs", "1,000 – 5,000 pcs", "5,000 – 25,000 pcs", "25,000+ pcs"].map(
                      (o) => (
                        <option key={o} className="bg-navy">
                          {o}
                        </option>
                      )
                    )}
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none border border-white/15 bg-ink px-4 py-3.5 text-sm text-white outline-none transition-colors placeholder:text-white/25 focus:border-gold"
                  />
                </div>
                <div className="sm:col-span-2">
