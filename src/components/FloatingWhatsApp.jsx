...
const WA_URL =
  ...
  encodeURIComponent("Hi Peak Mode International — I want to discuss a production program.");
...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      className="group fixed bottom-5 left-5 z-50 flex items-center gap-2.5"
    >
